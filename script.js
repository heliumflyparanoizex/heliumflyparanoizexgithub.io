...
function initSite() {
    ...
    if (galleryContainer) {
        ...
        // Función para abrir el Lightbox con gestión de foco
        const openLightbox = (src) => {
            ...
            // Shift focus al botón de cerrar
            if (closeLightbox) {
                setTimeout(() => closeLightbox.focus(), 10);
            }
        };

        // Función para cerrar el Lightbox con gestión de foco
        ...
        galleryImages.forEach(src => {
            ...
            item.setAttribute('aria-label', 'Ampliar imagen de la galería');
