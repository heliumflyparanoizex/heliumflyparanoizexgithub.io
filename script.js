...
function initSite() {
    ...
    if (galleryContainer) {
        ...
        galleryImages.forEach(src => {
            ...
            // Funciones de apertura y cierre refactorizadas para accesibilidad
            const openLightbox = () => {
                ...
                if (closeLightbox) {
                    closeLightbox.focus(); // Mover el foco al modal
                }
            };
            ...
            // Evento Teclado para activar Lightbox (Enter/Espacio)
