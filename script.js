...
function initSite() {
    ...
    if (galleryContainer) {
        ...
        // Function to handle closing lightbox and restoring focus
        const closeLightboxAndRestoreFocus = () => {
        ...
        // Cerrar Lightbox
        if (closeLightbox) {
            closeLightbox.setAttribute('role', 'button'); // Explicitly define role for screen readers
